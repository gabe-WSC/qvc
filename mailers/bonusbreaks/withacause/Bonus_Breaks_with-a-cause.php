			...
			<table class="outer" align="center" style="border-spacing:0;font-family:sans-serif;color:#333333;Margin:0 auto;width:100%;max-width:600px;" >
				<tr>
					<td align="center" class="full-width-image" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
						<span style="font-size: 12px; text-align:center; color: #666666; font-family: sans-serif">Trouble viewing this? <a href="#">Click here.</a></span> <img src="http://qvc.co.za/mailers/bonusbreaks/withacause/QVC_BBWAC_Header-Image.jpg" width="600" alt="" style="border-width:0;width:100%;max-width:600px;height:auto;" />
					</td>
				</tr>
				<tr>
											...
											<tr>
												<td class="text" style="padding-bottom:0;padding-right:0;padding-left:0;padding-top:10px;" >
													<div style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;background-color:#662E91;" >
														...
														Weekend @ <strong>only R 1299</strong><br />
						...
						<table width="100%" style="border-spacing:0;font-family:sans-serif;color:#333333;" >
							<tr>
								<td class="inner contents" style="padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:10px;width:100%;text-align:left;" >
									...
									<p style="text-align:center;Margin:0;color:#666;font-size:14px;Margin-bottom:10px;" >Please take note that we will be closed for business on Friday, 14 April 2017 to Monday, 17 April 2017: we will open for business as usual on Tuesday, 18 April 2017.<br/><br />
									Until next time,<br />
									QVC</p></td>
							</tr>
						</table>
						...
						<table width="100%" style="border-spacing:0;font-family:sans-serif;color:#333333;" >
							<tr>
								<td class="inner contents footer" style="padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:10px;width:100%;text-align:left;" >
									...
									Offer valid for bookings confirmed before 31 August 2017<br />
									...
									Club stock only</p>
									<p style="font-size: 12px; color: #666666; text-align: center; font-family: sans-serif"><unsubscribe>Click here to unsubscribe</unsubscribe></p>
								</td>
							</tr>
						</table>
					</td>
