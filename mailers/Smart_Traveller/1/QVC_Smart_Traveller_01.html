...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<td style=" font-family:century gothic; color:#666; text-align:center; font-size:12px"><webversion>View web version</webversion></span></td>
		</tr>
		<tr>
			<td style="font-family:Century Gothic; font-size:12px; color:#666; text-align:center">Be sure to add <a href="mailto:noreply@qvc.co.za">noreply@qvc.co.za</a> to your address book or sfe sender list so that you don't miss out on any exclusive offers<br />
			 </td>
		</tr>
		<tr>
		...
		<tr>
			<td style=" font-family:century gothic; color:#666; text-align:center; font-size:12px"><unsubscribe>Unsubscribe here</unsubscribe></span></td>
		</tr>
	</tbody>
</table>
<script>
