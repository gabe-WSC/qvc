...
<body>
    ...
    <!-- jumbotron/header -->
    <div class="jumbotron-fluid myx-0" id="jumbotron" style="background-image: url(../images/background/back11.jpg);">
        <br>
    ...
    <div class="container">
        <div class="row">
            <h1 class="grey" style="padding:20px 20px 0px 20px; margin:0;">ROMANTIC RETREATS</h1><br><br>
            <p style="padding:20px 40px 20px 20px;">Free is the spirit of the one who loves as deeply and holds another as dear as you. You travel not only to see the world, but to share the way your special someone sees it. Whether you are looking to get hitched in the great outdoors or retreat into the wilderness, sharing and experiencing nature with the one you love, our QVC romantic breakaways will take your breath away.</p>
        </div>
