...
<body>
    ...
    <!-- jumbotron/header -->
    <div class="jumbotron-fluid myx-0" id="jumbotron" style="background-image: url(../images/background/back9.jpg);">
        <br>
    ...
    <div class="container">
        <div class="row">
            <h1 class="grey" style="padding:20px 20px 0px 20px; margin:0;">DIGITAL DETOX</h1><br><br>
            <p style="padding:20px 40px 20px 20px;">Step outside for a moment, look up at the sky and just really take in the beauty around you. Ditch the tech, go offline and free your mind, you can stop and actually smell the roses. Take back your free time, take charge of your 'offline' life and make your getaway a chance to really and truly get away. Get lost in a forest, or lose yourself in starry night skies, there might not be Wi-Fi, but we promise you will find a better connection. Update your state of mind, not your status, a QVC digital detox break is the perfect opportunity to disconnect… and reconnect.</p>
        </div>
