...
<body>
    ...
    <!-- jumbotron/header -->
    <div class="jumbotron-fluid myx-0" id="jumbotron" style="background-image: url(../images/background/back21.jpg);">
        <br>
    ...
    <div class="container">
        <div class="row">
            <h1 class="grey" style="padding:20px 20px 0px 20px; margin:0;">THE LONE TRAVELLER</h1><br><br>
            <p style="padding:20px 40px 20px 20px;">Missing those you have never met and being homesick for places you have never known, you find your bliss when you are by yourself. Travelling not to escape life, but so that life does not escape you, your concern lies not in finding your destination, rather on finding yourself. Relish the quiet paradise of the confines of your own mind, make a plan to go away, to walk the earth and let QVC take you where you need to be. Speak less, reflect more – away is a state of mind anyway.</p>
        </div>
