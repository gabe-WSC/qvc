...
<?php include('includes/second_nav.php');?>
  ...
  <!-- page content  -->
  <div class="container">
    <h1 class="grey pt-4">MAGALIES PARK</h1>
        <h2 class="grey">NORTH WEST</h2>
    <div class="row d-flex pt-4">
      <div class="left-div layout-margin-right">
        <div class="example-image d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center">
          <img src="../images/resorts/magaliespark/magaliespark_cover.jpg" alt="" width="325"
            height="300">
            <a href="../images/resorts/magaliespark/magaliespark_cover_large.jpg" class="photoGallery example-image-link" data-lightbox="magaliespark" data-title="Magalies Park">view photo gallery &gt;</a>
            <a class="example-image-link" href="../images/resorts/magaliespark/magaliespark_large1.jpg" data-lightbox="magaliespark" data-title="Magalies Park"></a>
            <a class="example-image-link" href="../images/resorts/magaliespark/magaliespark_large2.jpg" data-lightbox="magaliespark" data-title="Magalies Park"></a>
            <a class="example-image-link" href="../images/resorts/magaliespark/magaliespark_large3.jpg" data-lightbox="magaliespark" data-title="Magalies Park"></a>
              <a class="example-image-link" href="../images/resorts/magaliespark/magaliespark_large4.jpg" data-lightbox="magaliespark" data-title="Magalies Park"></a>
        </div>
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center py-4">
          <a href="../images/resorts/magaliespark/magaliespark_large1.jpg" data-lightbox="magaliespark2"
            data-title="Magalies Park"><img src="../images/resorts/magaliespark/magaliespark_small1.jpg"
              border="0" style="padding-right: 15px"></a>
          <a href="../images/resorts/magaliespark/magaliespark_large2.jpg" data-lightbox="magaliespark3"
            data-title="Magalies Park"><img src="../images/resorts/magaliespark/magaliespark_small2.jpg"
              border="0"></a>
        </div>
        ...
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center pb-4">
          <a href="../images/resorts/magaliespark/magaliespark_large3.jpg" data-lightbox="magaliespark4"
            data-title="Magalies Park"><img src="../images/resorts/magaliespark/magaliespark_small3.jpg"
              border="0" style="padding-right: 15px"></a>

          <a href="../images/resorts/magaliespark/magaliespark_large4.jpg" data-lightbox="magaliespark5"
            data-title="Magalies Park"><img src="../images/resorts/magaliespark/magaliespark_small4.jpg"
              border="0"></a>
        </div>
        ...
        <div><iframe width="100%" height="250" id="gmap_canvas"
            src="https://maps.google.com/maps?q=magalies%20park&t=&z=13&ie=UTF8&iwloc=&output=embed"
