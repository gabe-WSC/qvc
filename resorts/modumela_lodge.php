...
<head>
  ...
  <title>QVC - Modumela Lodge</title>
</head>
...
<?php include('includes/second_nav.php');?>
  ...
  <!-- page content  -->
  <div class="container">
    <h1 class="grey pt-4">MODUMELA LODGE</h1>
      ...
      <div class="left-div layout-margin-right">
        <div class="example-image d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center">
          <img src="../images/resorts/modumela_lodge/modumela_lodge_cover.jpg" alt="" width="325"
            ...
            <a class="example-image-link" href="../images/resorts/modumela_lodge/modumela_lodge_large1.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                            	<a class="example-image-link" href="../images/resorts/modumela_lodge/modumela_lodge_large2.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts/modumela_lodge/modumela_lodge_large3.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large4.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large5.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large6.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large7.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large8.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
                                                <a class="example-image-link" href="../images/resorts//modumela_lodge/modumela_lodge_large9.jpg" data-lightbox="modumela_lodge" data-title="Modumela Lodge"></a>
        ...
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center py-4">
          ...
          <a href="../images/resorts/modumela_lodge/modumela_lodge_large2.jpg" data-lightbox="modumela_lodge3"
            data-title="Modumela Lodge"><img src="../images/resorts/modumela_lodge/modumela_lodge_small2.jpg"
              border="0"></a>
        </div>
        ...
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center pb-4">
          ...
          <a href="../images/resorts/modumela_lodge/modumela_lodge_large4.jpg" data-lightbox="modumela_lodge5"
            data-title="Modumela Lodge"><img src="../images/resorts/modumela_lodge/modumela_lodge_small4.jpg"
              border="0"></a>
        </div>
        ...
        <div><iframe width="100%" height="250" id="gmap_canvas"
            src="https://maps.google.com/maps?q=modumela&t=&z=13&ie=UTF8&iwloc=&output=embed"
