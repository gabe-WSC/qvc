...
<body>
  ...
  <!-- page content  -->
  <div class="container">
    <h1 class="grey pt-4">KRIDZIL</h1>
    <h2 class="grey">MARGATE, SOUTH COAST - KWAZULU NATAL</h2>
    <div class="row d-flex pt-4">
      <div class="left-div layout-margin-right">
        <div class="example-image d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center">
          <img src="../images/resorts/kridzil/kridzil_cover.jpg" alt="" width="325" height="300">
          <a href="../images/resorts/baywater_village/baywater_village_cover_large.jpg"
            class="photoGallery example-image-link" data-lightbox="kridzil" data-title="Kridzil">view
            photo gallery &gt;</a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large1.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large6.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large2.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large3.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large4.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_large5.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
          <a class="example-image-link" href="../images/resorts/kridzil/kridzil_cover_large.jpg" data-lightbox="kridzil"
            data-title="Kridzil"></a>
        </div>
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center py-4">
          <a href="../images/resorts/kridzil/kridzil_large1.jpg" data-lightbox="kridzil2"
            data-title="Kridzil"><img src="../images/resorts/kridzil/kridzil_small1.jpg" border="0"
              style="padding-right: 15px"></a>
          <a href="../images/resorts/kridzil/kridzil_large2.jpg" data-lightbox="kridzil3"
            data-title="Kridzil"><img src="../images/resorts/kridzil/kridzil_small2.jpg" border="0"></a>
        </div>
        ...
        <div class="image-grid d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-center pb-4">
          <a href="../images/resorts/kridzil/kridzil_large3.jpg" data-lightbox="kridzil4"
            data-title="Kridzil"><img src="../images/resorts/kridzil/kridzil_small3.jpg" border="0"
              style="padding-right: 15px"></a>

          <a href="../images/resorts/kridzil/kridzil_large4.jpg" data-lightbox="kridzil5"
            data-title="Kridzil"><img src="../images/resorts/kridzil/kridzil_small4.jpg" border="0"></a>
        </div>
        ...
        <div><iframe width="100%" height="250" id="gmap_canvas"
            src="https://maps.google.com/maps?q=kridzil&t=&z=13&ie=UTF8&iwloc=&output=embed"
      ...
      <div class="right-div">
        ...
        <div class="outerWrapperBenefits m-0" style="padding:20px; background-color:#7c7c7c;">
          ...
          <ul class="indiResortss list-split">
            <?= $nearbyFacilities ?>
          </ul>
        </div>
